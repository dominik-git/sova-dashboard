  ...
  return (
    <Navigation>
      <MenuContent dark={themeColor}>
        ...
        <StyledLink dark={themeColor} id="home" to="#">
          Home
        </StyledLink>
          ...
          <Card>
            {ab.map(item => (
              <CardBody key={item.id}>
                <Item dark={themeColor} id={item.id} projectName={item.name} />
              </CardBody>
            ))}
          </Card>
        </UncontrolledCollapse>

        <StyledLink dark={themeColor} id="scoreCard" to="/scorecard">
          Score Card
        </StyledLink>

        <StyledLink dark={themeColor} id="settings" to="#">
          Settings
        </StyledLink>
